...
class AgentEventKind(str, Enum):
    ...
    CONTEXT_SUMMARY_COMPLETED = "context_summary_completed"
    CONTEXT_SUMMARY_FAILED = "context_summary_failed"
    SESSION_CONTEXT_LOADED = "session_context_loaded"
    SESSION_ARCHIVE_FAILED = "session_archive_failed"
    MEMORY_LOADED = "memory_loaded"
    MEMORY_SUMMARY_REQUESTED = "memory_summary_requested"
    MEMORY_SUMMARY_COMPLETED = "memory_summary_completed"
